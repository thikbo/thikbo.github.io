  ...
  if (empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    //Perform Regex On Payments
  ...
  } else
      {
          ...
          $postQuery = "INSERT INTO rpos_payments (pay_id, order_code, customer_id, pay_amt, pay_method) VALUES(?,?,?,?,?)";
          ...
          $rc = $postStmt->bind_param('sssss', $pay_id, $order_code, $customer_id, $pay_amt, $pay_method);
